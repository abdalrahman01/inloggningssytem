...
if (isset($_GET["user_id"]) && ($_SESSION["permission_level"] == "admin")) {
    ...
    if ($_POST["password1"] == $_POST["password2"]) {
        ...
        header("Location: users_list.php?msg=userUpdatedSucc", $http_response_header = 200);
    } else {
        header("Location: edit_user.php?msg=newpasswordsdontmatch");
    }
} else {
    header("Location: .");
}
    ...
    <div class="container">
        <form method="post" action="edit_user.php">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="permission_level" value="admin" <?php echo ($row["permission_name"] == "admin") ? "checked" : ""; ?> >
